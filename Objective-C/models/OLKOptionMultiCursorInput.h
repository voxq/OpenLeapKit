...
typedef enum {
    OLKOptionStrikeSideAny,
    OLKOptionStrikeSidePort,
    OLKOptionStrikeSideStarboard,
    OLKOptionStrikeSideIn,
    OLKOptionStrikeSideOut
}OLKOptionStrikeSide;
...
@protocol OLKOptionCursorInput <NSObject>
...
@protocol OLKOptionMultiCursorInput <OLKOptionCursorInput>
